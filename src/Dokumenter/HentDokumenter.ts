...
export async function UploadDocument(
  ...
  const request1 = await requestHelper.GetLectio(
    'https://www.lectio.dk/lectio/165/dokumentrediger.aspx?folderid=' + folderId,
  );

  const request2 = await requestHelper.UploadLectio(
    'https://www.lectio.dk/lectio/165/dokumentupload.aspx',
    filename,
    data,
  );
  ...
  const request3 = await requestHelper.PostLectio(
    'https://www.lectio.dk/lectio/165/dokumentrediger.aspx?folderid=' + folderId,
    request3_body,
  );
  ...
  const request4 = await requestHelper.PostLectio(
    'https://www.lectio.dk/lectio/165/dokumentrediger.aspx?folderid=' + folderId,
    request4_body,
  );
